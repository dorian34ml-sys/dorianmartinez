...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (btnCopiar) {
        btnCopiar.addEventListener('click', function() {
            const datos = `
Nombre: Dorian Martinez Lopez
Empresa: Dorian Martinez
Teléfono: +52 951 321 5657
Correo: dorian34ml@institutosanpablo.edu.mx
Web: https://dorian34ml-sys.github.io/dorianmartinez/
            `.trim();
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            const destinatario = 'dorian34ml@institutosanpablo.edu.mx';
